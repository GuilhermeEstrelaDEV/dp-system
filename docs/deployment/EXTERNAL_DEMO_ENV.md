...
| `CORS_ORIGINS`                    | No      | Render input              | Exact real frontend HTTPS origin, with no wildcard or trailing path           |
...
| Name             | Secret? | Source       | Non-secret example or rule                |
| ---------------- | ------- | ------------ | ----------------------------------------- |
| `VITE_API_URL`   | No      | Render input | Exact real API HTTPS URL ending in `/api` |
