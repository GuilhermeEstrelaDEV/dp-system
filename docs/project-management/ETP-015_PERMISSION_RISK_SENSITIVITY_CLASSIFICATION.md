...
**APPROVED.** As classificacoes tecnicas dos 19 codigos foram homologadas por Guilherme Estrela em 29/07/2026, sem condicoes bloqueadoras. Nenhuma migration, assignment ou autorizacao funcional foi criada.
...
| ----- | -------------------------------- | ---------------------- | --------- | --------------------------- | ----- | ------ | ----- | ------- | ---------- | ----------- | ---------- | ------------ | ------- | ----------------------------------------------------------------------- | -------- | ----------- | ----------------- | ----------------- | -------- | --------- | --------------------------------------------------------------- | ---------- | -------- |
| PC-01 | `platform.read`                  | platform               | read      | Leitura da plataforma       | H     | L      | L     | S       | N          | N           | N          | N            | GLOBAL  | Leitura transversal pode revelar estrutura e usuários, sem mutação      | MEDIUM   | SENSITIVE   | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | seed/consumidores; declaração humana registrada nesta execução  | 29/07/2026 | APPROVED |
| PC-02 | `platform.manage`                | platform               | manage    | Administração da plataforma | C     | C      | H     | S       | S          | S           | S          | S            | GLOBAL  | Autoridade administrativa transversal e potencial gestão de acesso      | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | seed/contexto; declaração humana registrada nesta execução      | 29/07/2026 | APPROVED |
| PC-03 | `delegation.manage`              | delegation             | manage    | Substituições temporárias   | H     | C      | H     | S       | S          | S           | S          | S            | COMPANY | Pode transferir capacidades e afetar segregação, com vigência/revogação | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/service; declaração humana registrada nesta execução | 29/07/2026 | APPROVED |
| PC-04 | `emergency_access.manage`        | emergency_access       | manage    | Acesso emergencial          | C     | C      | H     | S       | S          | S           | S          | S            | COMPANY | Concede acesso privilegiado emergencial, escopo e expiração             | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/service; declaração humana registrada nesta execução | 29/07/2026 | APPROVED |
| PC-05 | `payroll.review.view`            | payroll.review         | view      | Consulta conferência        | H     | L      | L     | S       | S          | S           | N          | N            | COMPANY | Expõe dados de folha, achados e histórico sem mutação                   | MEDIUM   | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | API/web/módulo; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-06 | `payroll.review.create`          | payroll.review         | create    | Abre ciclo                  | M     | H      | M     | S       | S          | S           | N          | N            | COMPANY | Cria agregado operacional ligado a execução de folha                    | HIGH     | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-07 | `payroll.review.finding.create`  | payroll.review.finding | create    | Cria achado                 | M     | H      | M     | S       | S          | S           | N          | N            | COMPANY | Achado pode bloquear submissão e alterar o fluxo de folha               | HIGH     | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-08 | `payroll.review.finding.resolve` | payroll.review.finding | resolve   | Resolve achado              | M     | H      | M     | S       | S          | S           | N          | N            | COMPANY | Remove impedimento operacional e influencia submissão                   | HIGH     | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-09 | `payroll.review.finding.reopen`  | payroll.review.finding | reopen    | Reabre achado               | M     | H      | M     | S       | S          | S           | N          | N            | COMPANY | Restaura impedimento e altera estado auditável do fluxo                 | HIGH     | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-10 | `payroll.review.submit`          | payroll.review         | submit    | Inicia/submete ciclo        | M     | H      | H     | S       | S          | S           | N          | S            | COMPANY | Avança ciclo para decisão e restringe alterações posteriores            | HIGH     | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-11 | `payroll.review.approve`         | payroll.review         | approve   | Aprova etapa                | H     | C      | H     | S       | S          | S           | N          | S            | COMPANY | Decisão formal em duas etapas e pré-condição de fechamento              | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | API/testes/módulo; declaração humana registrada nesta execução  | 29/07/2026 | APPROVED |
| PC-12 | `payroll.review.reject`          | payroll.review         | reject    | Rejeita ciclo               | M     | H      | H     | S       | S          | S           | N          | S            | COMPANY | Decisão relevante que devolve o ciclo para correção                     | HIGH     | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-13 | `payroll.review.close`           | payroll.review         | close     | Fecha ciclo                 | H     | C      | H     | S       | S          | S           | S          | S            | COMPANY | Consolida ciclo aprovado e impede alterações ordinárias                 | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-14 | `payroll.review.reopen`          | payroll.review         | reopen    | Reabre ciclo                | H     | C      | H     | S       | S          | S           | S          | S            | COMPANY | Invalida decisões anteriores e reabre edição controlada                 | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | controller/web; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-15 | `payroll.period.close.view`      | payroll.period.close   | view      | Consulta resumo             | H     | L      | L     | S       | S          | S           | N          | N            | COMPANY | Resumo de fechamento contém contexto de folha, sem mutação              | MEDIUM   | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | seed/módulo; declaração humana registrada nesta execução        | 29/07/2026 | APPROVED |
| PC-16 | `payroll.period.close.readiness` | payroll.period.close   | readiness | Avalia prontidão            | H     | M      | M     | S       | S          | S           | N          | N            | COMPANY | Consulta evidências e bloqueios que antecedem fechamento                | MEDIUM   | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | API/web/módulo; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
| PC-17 | `payroll.period.close.execute`   | payroll.period.close   | execute   | Fecha competência           | H     | C      | C     | S       | S          | S           | S          | S            | COMPANY | Fechamento canônico, manifesto e efeitos operacionais de alto impacto   | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | API/e2e/inventário; declaração humana registrada nesta execução | 29/07/2026 | APPROVED |
| PC-18 | `payroll.period.close.reopen`    | payroll.period.close   | reopen    | Reabre competência          | H     | C      | C     | S       | S          | S           | S          | S            | COMPANY | Cria sucessor, invalida estado fechado e exige controle rigoroso        | CRITICAL | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | API/e2e/inventário; declaração humana registrada nesta execução | 29/07/2026 | APPROVED |
| PC-19 | `payroll.period.close.history`   | payroll.period.close   | history   | Consulta histórico          | H     | L      | M     | S       | S          | S           | N          | N            | COMPANY | Expõe manifesto e timeline histórica de fechamento                      | MEDIUM   | RESTRICTED  | Guilherme Estrela | Guilherme Estrela | APPROVED | Nenhuma   | API/web/módulo; declaração humana registrada nesta execução     | 29/07/2026 | APPROVED |
