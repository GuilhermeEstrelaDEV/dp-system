...
| `branches`              | `company_id`, `code`, `name`, `tax_id nullable`, `address jsonb`, `status`                                                   | único `(company_id, code)` e `(company_id, tax_id)` | Company                    |
| `departments`           | `company_id`, `branch_id nullable`, `code`, `name`, `status`                                                                 | único `(company_id, code)`                          | Company, Branch            |
| `cost_centers`          | `company_id`, `code`, `name`, `status`                                                                                       | único `(company_id, code)`                          | Company                    |
| `positions`             | `company_id`, `code`, `name`, `description nullable`, `status`                                                               | único `(company_id, code)`                          | Company                    |
